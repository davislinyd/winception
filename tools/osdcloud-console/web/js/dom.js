...
export const elements = {
  ...
  updateReleaseLink: $('#update-release-link'),
  ...
  softwareTestCopy: $('#software-test-copy'),
  softwareTestAbort: $('#software-test-abort'),
  consoleSoftwareTestAbort: $('#console-software-test-abort'),
  ...
  beginnerHome: $('#beginner-home'),
  beginnerOverallBadge: $('#beginner-overall-badge'),
  beginnerNextTitle: $('#beginner-next-title'),
  beginnerNextDetail: $('#beginner-next-detail'),
  beginnerWhy: $('#beginner-why'),
  beginnerNextHint: $('#beginner-next-hint'),
  beginnerBlockerSummary: $('#beginner-blocker-summary'),
  beginnerPrimaryAction: $('#beginner-primary-action'),
  beginnerSecondaryAction: $('#beginner-secondary-action'),
  beginnerStepSetup: $('#beginner-step-setup'),
  beginnerStepContent: $('#beginner-step-content'),
  beginnerStepEnvironment: $('#beginner-step-environment'),
  beginnerStepServices: $('#beginner-step-services'),
  beginnerSummaryItems: $('#beginner-summary-items'),
  beginnerPxeCard: $('#beginner-pxe-card'),
  guidedShell: $('#guided-shell'),
  consoleBoard: $('#console-board'),
  operatorModeGuided: $('#operator-mode-guided'),
  operatorModeConsole: $('#operator-mode-console'),
  managementDialog: $('#management-dialog'),
  managementOpenButton: $('#management-open-button'),
  ...
  operationErrorDialog: $('#operation-error-dialog'),
  operationErrorTitle: $('#operation-error-title'),
  operationErrorMessage: $('#operation-error-message'),
  operationErrorAction: $('#operation-error-action'),
  operationErrorClose: $('#operation-error-close'),
};
