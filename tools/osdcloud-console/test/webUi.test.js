...
test('v1 metadata stays frozen while the root package tracks v2', () => {
  ...
  assert.equal(packageJson.version, '2.0.0-alpha.13');
  assert.equal(packageLock.version, '2.0.0-alpha.13');
  assert.equal(packageLock.packages[''].version, '2.0.0-alpha.13');
