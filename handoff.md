...
2. Refresh installed host idle/API/NIC/VM state. Current read-only snapshot: operationfalse/fleet0/services0; AutoLab192.168.177.1, activeIZVZO7PU/image25H2, installed workspace runtimeC:\OSDCloud; auth.requiredfalse. Acceptance installed reload completed at22:59 from dae06b2; protected State backup HostTools-State-20260914-145854-135. HTTP source hash matches. Endpoint Sync completed; Preflight29/29; published WinPE hash EFE3AFE948B177BC8624A4EA7B8E20D66015F3F021DF2FA1ECA3BB0AC8BF7CE4. CLI79303 ended. Lab prerequisite passed .ai/acceptance-lab-prerequisite.json/log. Router Create failed on localized NIC name, leaving owned Off VM/base disk, no clean checkpoint. NIC-object fix and guarded -Create -ResumeCreate passed PS8/8; commit then resume. No DHCP or deployment started.
