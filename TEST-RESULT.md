...
| Expanded AutoLab | NotRun | Router Create failed on localized default NIC name, leaving owned powered-off VM/base disk and no checkpoint; source fix uses NIC object with explicit guarded ResumeCreate. Bootstrap/network rounds not executed yet |
