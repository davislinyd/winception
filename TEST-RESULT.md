...
| Expanded AutoLab | NotRun | Owned router Create/Clean checkpoint succeeded after localized NIC fix. Initial Bootstrap stopped before mutation on relative config path; Resolve-Path fix and 24 focused tests passed; Bootstrap ValidateOnly Passed. Deployment/network rounds not executed yet |
